...
export default function HomePage() {
  ...
  useEffect(()=>{
    axios.get("https://8080-ffebceeacfaacbbedddeecfbcbaca.project.examly.io/home/"+sessionStorage.getItem('user'))
    .then((res)=>{
  ...
  function handleAddtoCart(index){
    axios.post("https://8080-ffebceeacfaacbbedddeecfbcbaca.project.examly.io/addToCart",{
