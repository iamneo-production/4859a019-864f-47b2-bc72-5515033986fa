...
export default function AddProduct() {
    ...
    function handleSubmit(e){
        ...
        console.log(e);
        if(state!=null){
          axios.put("http://https://8080-fbedfcfaaeeeeafacbbedddeecfbcbaca.project.examly.io//admin/productEdit/"+state.id,{
        ...
        axios.post("http://lhttps://8080-fbedfcfaaeeeeafacbbedddeecfbcbaca.project.examly.io//admin/addProduct",{
            productName:e.target['0']['value'],
            price:e.target['1']['value'],
            description : e.target['2']['value'],
            imageurl:e.target['3']['value'],
