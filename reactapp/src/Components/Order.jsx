...
export default function Order() {
  ...
  let totalPrice=0;
  useEffect(()=>{
    axios.get("https://8080-ffebceeacfaacbbedddeecfbcbaca.project.examly.io/orders/"+sessionStorage.getItem('user'))
    .then((res)=>{
  ...
  async function handlePayment(e,tPrice){
    let result = ""
    await axios.get("https://8080-ffebceeacfaacbbedddeecfbcbaca.project.examly.io/orders/checkQuantity/"+sessionStorage.getItem('user'))
    .then((res)=>{
      result =res.data;
    ...
    if(result.length !== 0){
      alert("Out of stock for " + result);
        ...
        axios.post("https://8080-ffebceeacfaacbbedddeecfbcbaca.project.examly.io/payment/initialize",{totalPrice : tPrice}).then(res=>{
            var options = {
                "name": "AmazePack",
                "description": "Pay Your Transaction",
                "image": "https://8080-ffebceeacfaacbbedddeecfbcbaca.project.examly.io/your_logo",
                "order_id": res.data, //This is a sample Order ID. Pass the `id` obtained in the response of Step 1
                "handler": function (response){
                    axios.post("https://8080-ffebceeacfaacbbedddeecfbcbaca.project.examly.io/payment/confirm",
