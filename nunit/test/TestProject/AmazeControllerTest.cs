...
            // Send an HTTP GET request to the API endpoint.
 ...
 HttpResponseMessage response = await _httpClient.GetAsync("/home");
...
            // Send an HTTP GET request to the API endpoint.
 ...
 HttpResponseMessage response = await _httpClient.GetAsync("admin/orders");
...
            // Send an HTTP GET request to the API endpoint.
 ...
 HttpResponseMessage response = await _httpClient.GetAsync("admin/productEdit");
...
            // Send an HTTP GET request to the API endpoint.
 ...
 HttpResponseMessage response = await _httpClient.GetAsync("admin/cart");
...
HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, "/signup");
